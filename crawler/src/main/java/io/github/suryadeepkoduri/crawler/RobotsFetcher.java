...
public class RobotsFetcher {
    ...
    public byte[] fetch(String url) {
        try {
            ...
            log.error(
                "IOException while fetching robots.txt from url:{}",
                url,
                e
            );
        } catch (InterruptedException e) {
            log.error(
                "InterruptedException while fetching robots.txt from url:{}",
                url,
                e
            );
            ...
            log.error(
                "IllegalArgumentException while fetching robots.txt from url:{}",
                url,
                e
            );
        }
