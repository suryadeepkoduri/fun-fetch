...
class UrlProcessorTest {
    ...
    void removeTrailingSlash() {
        assertEquals(
            ...
            UrlProcessor.normalize("https://example.com/page/")
        );
    }
    ...
    void removeFragment() {
        assertEquals(
            "https://example.com/page",
            UrlProcessor.normalize("https://example.com/page#section")
        );
    }
    ...
    void removeFbclid() {
        assertEquals(
            "https://example.com/page",
            UrlProcessor.normalize("https://example.com/page?fbclid=abc123")
        );
    }
    ...
    void removeWww() {
        assertEquals(
            "https://example.com/page",
            UrlProcessor.normalize("https://www.example.com/page")
        );
    }
    ...
    void removeDefaultHttpPort() {
        assertEquals(
            ...
            UrlProcessor.normalize("http://example.com:80/page")
        );
    }
    ...
    void removeDefaultHttpsPort() {
        assertEquals(
            "https://example.com/page",
            UrlProcessor.normalize("https://example.com:443/page")
        );
    }
    ...
    void sortQueryParameters() {
        assertEquals(
            ...
            UrlProcessor.normalize("https://example.com/page?b=2&a=1")
        );
    }
    ...
    void keepNonDefaultPort() {
        assertEquals(
            ...
            UrlProcessor.normalize("http://example.com:8080/page")
        );
    }
    ...
    void normalize_removesUtmButKeepsOtherParams() {
        assertEquals(
            "https://example.com/page?q=search",
            UrlProcessor.normalize(
                "https://example.com/page?q=search&utm_source=twitter"
            )
        );
    }
    ...
    void normalize_removesFbclidButKeepsOtherParams() {
        assertEquals(
            "https://example.com/page?q=search",
            UrlProcessor.normalize(
                "https://example.com/page?q=search&fbclid=abc123"
            )
        );
    }
    ...
    void getRobotUrl_returnsRobotsTextPath() {
        assertEquals(
            ...
            UrlProcessor.getRobotUrl("https://example.com/some/page")
        );
    }
    ...
    void getRobotUrl_stripsWww() {
        assertEquals(
            "https://example.com/robots.txt",
            UrlProcessor.getRobotUrl("https://www.example.com/page")
        );
    }
    ...
    void getRobotUrl_lowercasesHost() {
        assertEquals(
            "https://example.com/robots.txt",
            UrlProcessor.getRobotUrl("https://EXAMPLE.COM/page")
        );
    }
    ...
    void getRobotUrl_stripsQueryParams() {
        assertEquals(
            "https://example.com/robots.txt",
            UrlProcessor.getRobotUrl("https://example.com/page?q=search")
        );
    }
    ...
    void getRobotUrl_stripsFragment() {
        assertEquals(
            "https://example.com/robots.txt",
            UrlProcessor.getRobotUrl("https://example.com/page#section")
        );
    }
